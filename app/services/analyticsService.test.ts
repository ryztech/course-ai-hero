...
describe("analyticsService", () => {
  ...
  describe("getAdminAnalyticsSummary", () => {
    it("returns zeros and null when no data exists", () => {
    ...
    it("identifies the top earning course", () => {
      ...
      expect(result.topEarningCourse).not.toBeNull();
      expect(result.topEarningCourse!.title).toBe("Best Seller");
      expect(result.topEarningCourse!.revenue).toBe(9999);
    });
    ...
    it("returns null topEarningCourse when all purchases are outside the period", () => {
